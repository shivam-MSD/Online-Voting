...
<html onload="displayError()">
    <head>
        ...
        <title>Add New Candidate Details</title>
    ...
    <body onload="displayError()" id="bodyid" ng-app="myApp" ng-controller="myCtrl">
        ...
        <div class="container">
            ...
            <form  class="form" action="addcitycandidatesuccess" method="post" style="background-image: url('evote1.jpg')" >
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <label for="positionid">Municipal Corporation of </label>
                        <input type="text" class="form-control"  name="municorpo" id="municorpoid" required  value="${candidate.city}"  readonly>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">        
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="file" id="imgid" name="partylogo" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">        
                        <label for="mobnoid">Candidate of which state? Select State</label><br>
                    ...
                    <div class="form-group col-md-6">        
                        ...
                        <select id="citySelect" size="1" class="form-control"  required name="city"  onchange="displaymunicipalcorporationfield()" >
                            <option value="Choose City" disabled selected>Choose City</option>
                            <!--<option></option>-->
                        </select>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="positionid">Area</label>
                        <input type="text" class="form-control" placeholder="Enter arear name" name="area" id="areaid" required value='${candidate.area}' >
                    </div>
                    <div class="form-group col-md-6">        
    ...
    <script>
        ...
        function displaymunicipalcorporationfield()
        {
//            alert("muccorpo = " + document.getElementById("municorpoid").value + "  city = " + document.getElementById("citySelect").value);
            document.getElementById("municorpoid").value = document.getElementById("citySelect").value;
        }
