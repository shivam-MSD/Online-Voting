<%-- 
    Document   : AddnewSubadmincheckdetails
    Created on : 16 May, 2022, 11:32:36 PM
    Author     : Admin
--%>
...
<html onload="displayError()">
    <head>
        ...
        <title>Add New SubAdmin Details </title>
    ...
    <body onload="displayError()" id="bodyid" ng-app="myApp" ng-controller="myCtrl">
        ...
        <div class="container">
            ...
            <form  class="form" action="addsubadminsuccess" method="post" style="background-image: url('evote1.jpg')" ng-submit="save(myForm)">
                ...
                <div class="form-row">
                    ...
                    <!--                    <div class="form-group col-md-6">        
                                            ...
                                            <input type="text" class="form-control" placeholder="city" name="city" value="${addadminmsg.city}" id="cityid" readonly>
                                        </div>-->
                </div>
