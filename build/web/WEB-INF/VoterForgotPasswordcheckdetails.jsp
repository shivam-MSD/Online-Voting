<%-- 
    Document   : VoterForgotPasswordcheckdetails
    Created on : 1 Jun, 2022, 7:10:28 PM
    Author     : Admin
--%>
            ...
            <!--<form  class="form" action="successfullyupdated" method="post">-->
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">     
                        ...
                        <input type="text" class="form-control" placeholder="voterID" name="vid" id="vidid" required value = "${r.vid}" readonly>
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-12" >        
                        ...
                        <input type="email" class="form-control" placeholder="Email id" name="email"value="${r.email}" id="emailid" readonly>
                    </div>
                </div>
                    ...
                    <div class="form-group col-md-6">        
                        ...
                        <input type="text" class="form-control" placeholder="New Password" value="${r.password}" name="password" id="passwordid" >
                    </div>
                    <!--</div>-->
                    ...
                    <div class="form-group col-md-6">        
                        ...
                        <input type="text" class="form-control" placeholder="Confirm Password" value="${r.password}" name="confirmpassword" id="passwordid" >
                    </div>
                </div>
                ...
                <center>
                    ...
                    <div class="form-group col-md-4" hidden > 
                        ...
                        <input type="number" class="form-control" name="OTPhidden" id="OTPOTPhiddenid" value="${r.OTPhidden}" readonly >
                    </div>
                        <br>
