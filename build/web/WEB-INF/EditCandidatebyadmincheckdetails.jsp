<%-- 
    Document   : EditCandidatebyadmincheckdetails
    Created on : 19 May, 2022, 12:33:38 PM
    Author     : Admin
--%>

<%-- 
    Document   : Addcandidatecheckdetails
    Created on : 17 May, 2022, 7:52:15 PM
    Author     : Admin
--%>
...
<html onload="displayError()">
    ...
    <body onload="displayError()" id="bodyid" ng-app="myApp" ng-controller="myCtrl">
        ...
        <div class="container">
            ...
            <form  class="form" action="editcandidatesuccess" method="post" style="background-image: url('evote1.jpg')" ng-submit="save(myForm)">
                ...
                <div class="form-row" hidden>
                    <div class="form-group col-md-6" >        
                        ...
                        <input type="number" class="form-control" placeholder="Aadharcard Number" name="aadharno" id="aadharno"  min="111111111111" max="999999999999" value='${candidate.aadharno}' readonly>
                    </div>
                    <div class="form-group col-md-6">        
                        <label for="pannoid">Pan Number</label>
                        <input type="text" class="form-control" placeholder="Pan Number" name="panno" id="pannoid"  value='${candidate.panno}' readonly>
                    </div>
                </div>
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">        
                        ...
                        <select id="citySelect" size="1" class="form-control"  required name="city" >
                            <option value="${candidate.city}" disabled selected>Choose City</option>
                            <option></option>
                        </select>
                    </div>
                </div>
