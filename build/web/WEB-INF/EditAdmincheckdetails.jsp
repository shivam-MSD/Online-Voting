...
<html onload="displayError()">
    ...
    <body onload="displayError()" id="bodyid" ng-app="myApp" ng-controller="myCtrl">
        ...
        <div class="container">
            ...
            <form  class="form" action="editadmin/editadminsuccess" method="post" style="background-image: url('evote1.jpg')" ng-submit="save(myForm)">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">        
                        ...
                        <input type="text" class="form-control" placeholder="" name="state" value="${addadminmsg.state}" id="stateid" readonly>
                    </div>
                </div>
