<%-- 
    Document   : AddNewSubadmin
    Created on : 16 May, 2022, 11:24:54 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body onload="loadpage()" id="bodyid">
        ...
        <div class="container">
            ...
            <!--<form  class="form" action="checkdetails" method="POST" style="background-image: url('evote1.jpg')">-->
                ...
                <div class="form-row">
                    <div class="form-group col-md-12" hidden>        
                        <label for="stateadminid">Admin Id</label>
                        <input type="text" class="form-control" placeholder="AdminID" name="stateadmin" id="stateadminid" required value='GJAid' >
                    </div>
                    ...
                    <div class="form-group col-md-12">        
                        ...
                        <input type="text" class="form-control" placeholder="VoterID" name="vid" id="vidid" required value='${addadminmsg.vid}' >
                    </div>
                </div>
                <center>
