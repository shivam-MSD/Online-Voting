...
<html>
    ...
    <script>
        function loadpage()
        {
            ...
            alert("Admin remove successfully....");
//            alert("state = " + state.value + " city = " + city.value);
            
            if (state.value === "adminremove")
            {
//                alert("1.  state = " + state.value + " city = " + city.value);
                window.open("/HeadAdmin/login/adminheaddashboard", "_self");
//                window.open("https://online-evoting.herokuapp.com/HeadAdmin/login/adminheaddashboard", "_self");
            }
            else if (state.value == "subadminremove")
            {
//                alert("2.   state = " + state.value + " city = " + city.value);
