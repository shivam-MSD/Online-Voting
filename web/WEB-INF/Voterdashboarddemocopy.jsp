                    ...
                    <div class="table-responsive" id="votervotingdashboardtablediv" >
                        <table class="table" style="font-weight: bold;  text-align: center;">
                            ...
                            <c:forEach var="row" items="${data.rows}">
                                ...
                                <!--here i have change id id="modalCenter4"-->
                                <!--                               <div id="modalCenter41" class="modal fade" tabindex="-1">
                                                                    <div class="modal-dialog modal-dialog-centered">
                                                                        ...
                                                                        <div class="modal-content"  style="padding: 15px;">
                                                                            ...
                                                                            <b> <h6>Please enter 6 digit Email verification code [OTP] which is sent to your registered emailid for evoting.:-</h6></b>
                                                                            <br>
                                                                            
                                                                            <input class="form-control" type="number" name="OTP" id="OTPinput"  style="font-weight: bold;" >
                                                                            <br>
                                                                            <input class="form-control" type="number" name="OTPhidden" id="OTPhiddeninput"  readonly style="font-weight: bold;" >
                                                                                    ...
                                                                                    <div class="modal-dialog modal-dialog-centered">
                                                                                        ...
                                                                                        <div class="modal-content"  style="padding: 15px;">
                                                                                            ...
                                                                                            <form action="subadmindashboard/removecitycandidate" method="post" class="form-control" style="font-weight: bold;">
                                                                                                <form action="removeadmin" method="post">
                                                                                                <b>VoterID :</b>
                                                                                                <input class="form-control" type="text" name="candidatevid" id="cididinput" readonly style="font-weight: bold;">
                                                                                                <b>Candidate Name :</b>
                                                                                                <input class="form-control" type="text" name="cname" id="cidnameinput"  readonly style="font-weight: bold;">
                                                                                                <b>State</b>
                                                                                                ...
                                                                                                <div class="modal-footer">
                                                                                                    <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="Electionprocess()">Yes</button>
                                                                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No</button>
                                                                                                </div>
                                                                                            </form>
                                                                                        </div>
...
//                alert("data = " + data);
        ...
        <%
            ...
            voterloginid = (String) session.getAttribute("voterloginid");
            if (voterloginid == null) {
        %>
            window.open("https://online-evoting.herokuapp.com/Home/Voting/login", "_self");
        <%
            }
