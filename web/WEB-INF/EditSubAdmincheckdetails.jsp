<%-- 
    Document   : EditSubAdmincheckdetails
    Created on : 17 May, 2022, 9:56:24 PM
    Author     : Admin
--%>

<%-- 
    Document   : EditAdmin
    Created on : 15 May, 2022, 7:47:28 AM
    Author     : Admin
--%>
...
<html onload="displayError()">
    ...
    <body onload="displayError()" id="bodyid" ng-app="myApp" ng-controller="myCtrl">
        ...
        <div class="container">
            ...
            <form  class="form" action="editsubadmin/editsubadminsuccess" method="post" style="background-image: url('evote1.jpg')" ng-submit="save(myForm)">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">        
                        ...
                        <input type="text" class="form-control" placeholder="Name" name="name" id="nameid" value="${addadminmsg.name}" >
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">        
                        ...
                        <input type="email" class="form-control" placeholder="Email id" name="email" id="emailid" value='${addadminmsg.email}' required data-toggle="popover" title="Email ID" data-content="You will receive Email Verification code at the time of registration and online Voting.So enter appropriate emailid" >
                ...
                <div class="form-row">     
                    <div class="form-group col-md-6">        
                        ...
                        <!--<input type="text" class="form-control" placeholder="State" name="state" value="${addadminmsg.state}" id="stateid" readonly>-->
                        <input type="text" id="stateid" class="form-control"  required name="state" value="${addadminmsg.state}" readonly>
                    </div>

                    <div class="form-group col-md-6">        
                        <label for="mobnoid">Admin of which city? Select City</label><br>
                        <input type="text" id="cityid" class="form-control"  required name="city" value="${addadminmsg.city}" readonly>
                        </select>
                    </div>
                </div>
                <center>
